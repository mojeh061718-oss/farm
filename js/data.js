...
const DATA = (() => {
  ...
  const CROPS = {
    turnip:     { seed: 8,  grow: 35,  seasons: [0],       xp: 4,  tpl: 'root',    color: '#d9c8e4', leaf: '#5a8f4a' },
    wheat:      { seed: 6,  grow: 45,  seasons: [0, 1, 2], xp: 4,  tpl: 'grain',   color: '#cfa94e', leaf: '#8aab55', grain: true },
    carrot:     { seed: 12, grow: 50,  seasons: [0, 2],    xp: 6,  tpl: 'root',    color: '#d8731c', leaf: '#6d9440' },
    potato:     { seed: 18, grow: 70,  seasons: [0, 2],    xp: 8,  tpl: 'root',    color: '#af8a5f', leaf: '#4f7a2c' },
    rice:       { seed: 24, grow: 65,  seasons: [0, 1],    xp: 8,  tpl: 'grain',   color: '#e8e2cc', leaf: '#4b9e93', grain: true },
    garlic:     { seed: 30, grow: 85,  seasons: [0, 3],    xp: 10, tpl: 'root',    color: '#e7e3d6', leaf: '#6d9440' },
    strawberry: { seed: 42, grow: 85,  seasons: [0],       xp: 9,  tpl: 'bush',    color: '#c73530', leaf: '#3f8a42', regrow: 40 },
    tomato:     { seed: 48, grow: 95,  seasons: [1],       xp: 10, tpl: 'bush',    color: '#c73530', leaf: '#2c6e30', regrow: 45 },
    pepper:     { seed: 55, grow: 105, seasons: [1],       xp: 11, tpl: 'bush',    color: '#e0653c', leaf: '#31601c', regrow: 50 },
    corn:       { seed: 45, grow: 120, seasons: [1, 2],    xp: 16, tpl: 'grain',   color: '#e3c232', leaf: '#4f7a2c', tall: true, grain: true },
    melon:      { seed: 70, grow: 140, seasons: [1],       xp: 22, tpl: 'vine',    color: '#5da360', leaf: '#31601c', stripe: '#2c6e30' },
    sunflower:  { seed: 60, grow: 130, seasons: [1],       xp: 18, tpl: 'flower',  color: '#e3c232', leaf: '#4f7a2c' },
    grapes:     { seed: 95, grow: 150, seasons: [2],       xp: 16, tpl: 'trellis', color: '#6d4f9e', leaf: '#4f7a2c', regrow: 65 },
    cabbage:    { seed: 62, grow: 110, seasons: [2],       xp: 18, tpl: 'leafy',   color: '#74a877', leaf: '#347137' },
    yam:        { seed: 68, grow: 125, seasons: [2],       xp: 20, tpl: 'root',    color: '#a35a44', leaf: '#5f7d33' },
    pumpkin:    { seed: 85, grow: 150, seasons: [2],       xp: 26, tpl: 'vine',    color: '#d2691e', leaf: '#31601c', stripe: '#a85417' },
    kale:       { seed: 42, grow: 90,  seasons: [3],       xp: 14, tpl: 'leafy',   color: '#45a396', leaf: '#0a6b5e' },
    frostberry: { seed: 90, grow: 135, seasons: [3],       xp: 24, tpl: 'bush',    color: '#6a77b8', leaf: '#324a45' },
  };
